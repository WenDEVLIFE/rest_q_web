        ...
        <div className="flex w-full md:w-auto flex-wrap items-center gap-3">
          <div className="relative group flex-1 min-w-[220px]">
            ...
            <input 
              ...
              className="w-full sm:w-64 pl-9 pr-4 py-2.5 bg-slate-50 border-2 border-slate-100 rounded-xl text-sm font-bold text-slate-700 placeholder:text-slate-400 focus:outline-none focus:border-primary/20 focus:ring-4 focus:ring-primary/5 transition-all"
            />
          </div>
          <button 
